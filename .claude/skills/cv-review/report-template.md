...
Sezioni fisse, in quest'ordine, nessuna in più. Compilare ogni riga; niente sezioni vuote (scrivere `Nessuno` o `N/A`).

```markdown
# Valutazione CV – <Nome Cognome> per <Titolo posizione>
